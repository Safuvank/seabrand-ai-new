...
// import { aboutData } from "@/src/data/about.data"; // Ensure this path matches your setup

// export default function AboutHero() {
//   return (
//     <section className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16 relative z-10 mb-20 md:mb-28">
//       <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-24">
//         {/* Left Content */}
//         <div className="max-w-3xl">
//           <div className="inline-block px-4 py-1.5 rounded-full bg-zinc-200/50 border border-zinc-200 text-sm font-semibold text-zinc-600 mb-6">
//             {aboutData.hero.badge}
//           </div>
//           {/* Using whitespace-pre-line allows the \n in your data to create a line break */}
//           <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-black leading-tight mb-8 whitespace-pre-line">
//             <span className="text-[#6748FE]">Curating</span>
...
//           <svg
//             className="w-10 h-10 text-zinc-300 mb-6"
//             fill="currentColor"
//             viewBox="0 0 24 24"
//           >
